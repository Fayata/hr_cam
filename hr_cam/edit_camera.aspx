<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="edit_camera.aspx.cs" Inherits="hr_cam.edit_camera" %>
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                        <h5 class="text-white text-capitalize ps-3">Edit Camera</h5>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div style="margin: 15px;">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">Camera Site</label>
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <asp:TextBox ID="TextBox7" CssClass="form-control" runat="server" ClientIDMode="Static" style="display:none;"></asp:TextBox>
                                <div class="mb-3">
...
<script>
    $(document).ready(function () {
        var x = document.getElementById("TextBox7").value;
        //alert(x);
