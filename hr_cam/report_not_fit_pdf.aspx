<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_not_fit_pdf.aspx.cs" Inherits="hr_cam.Report_not_fit_pdf" %>
            ...
            <table class="table" style="width:100%" aria-describedby="report">
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        ...
                        <b style="font-size:20px">Report Face Recognition Invalid or Exception</b>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2">
