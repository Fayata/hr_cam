<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_people_pdf.aspx.cs" Inherits="hr_cam.Report_people_pdf" %>
            ...
            <table style="width:100%" aria-describedby="report">
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <b style="font-size:20px">Report Unique Face Recognition</b>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2">
