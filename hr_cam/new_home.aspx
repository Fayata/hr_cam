<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="new_home.aspx.cs" Inherits="hr_cam.new_home" %>
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="card">
                                    <div class="card-header p-3 pt-2">
                                        ...
                                        <div class="text-end pt-1">
                                            <p class="text-sm mb-0 text-capitalize">Blacklist Detection</p>
                                            <p> This Month</p>
                                            <h4 class="mb-0">
                                ...
                                <div class="card">
                                    <div class="card-header p-3 pt-2">
                                        ...
                                        <div class="text-end pt-1">
                                            ...
                                            <p class="text-sm mb-0 text-capitalize">Today's Unique</p>
                                            <p>Fit To Work</p>
                                            <h4 class="mb-0">
                            ...
                            <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4">
                                <div class="card">
                                    <div class="card-header p-3 pt-2">
                                        ...
                                        <div class="text-end pt-1">
                                            <p class="text-sm mb-0 text-capitalize">
                                                Unique License Plate</p>
                                            <p>Detected This Month</p>
                                            <h4 class="mb-0">
            ...
            <div class="col-md-12">
                <div class="card z-index-2 ">
                    ...
                    <table style="width: 100%; margin: 10px;" aria-describedby="filter">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="auto_refresh" id="auto_refresh" checked></td>
                            <td>
                                <label for="refresh_interval">Interval Refresh perdetik:</label>
                            </td>
                            <td>
                                <input type="number" id="refresh_interval" value="30" min="1" class="form-control">
                                <!-- default 30 detik -->
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox3" runat="server" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></td>
                            <td>
                ...
                <div class="col mt-4 mb-3">
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="border-radius-lg py-3 pe-1" style="background: darkred;">
