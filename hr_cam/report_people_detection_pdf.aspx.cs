...
namespace hr_cam
{
    public partial class Report_people_detection_pdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //Response.Write("camera site:"+Session["site_people_detection"].ToString());
                //Response.Write("camera:"+Session["camera"].ToString());
                //Response.Write("from_people_detection:"+Session["from_people_detection"].ToString());
                //Response.Write("to_people_detection:"+Session["to_people_detection"].ToString());
                FillEventHistory();
            }
        }
