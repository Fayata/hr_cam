...
namespace hr_cam
{
    public partial class Report_traffic_detection_pdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //Response.Write("camera site:"+Session["site_traffic_detection"].ToString());
                //Response.Write("camera:"+Session["camera"].ToString());
                //Response.Write("from_traffic_detection:"+Session["from_traffic_detection"].ToString());
                //Response.Write("to_traffic_detection:"+Session["to_traffic_detection"].ToString());
                FillEventHistory();
            }
        }
