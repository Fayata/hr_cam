...
namespace hr_cam
{
    public partial class Vms : System.Web.UI.Page
    {
        ...
        private void FillTableFromDatabase()
        {
            using (MySqlConnection con = new MySqlConnection(strcon))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand("SELECT * from video_management_systems", con))
                {
                    using (MySqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            string deleteUrl = "delete_vms.aspx?id=" + vmsId;
                            ...
                            deleteButtonHtml += "</a>";
                            //string deleteButtonHtml = "<a href=\"\" class=\"btn btn-danger\" onclick=\"confirmDelete(event," + vmsId + ")\">";
                            //deleteButtonHtml += "<span class='btn-icon'><i class='fa-solid fa-trash-can'></i></span>";
                            //deleteButtonHtml += "</a>";
