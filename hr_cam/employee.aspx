<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="employee.aspx.cs" Inherits="hr_cam.employee" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                ...
                <h5 class="text-white text-capitalize ps-3">Face Recognition MCU</h5>
              </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="card-body px-0 pb-2">
                <div class="row justify-content-right mb-5">
                    ...
                    <div class="col-4" style="flex: 0 0 auto;">
                        ...
                        <a href="#" class="btn btn-warning">Sync to VMS</a>
...
<script type="text/javascript">
    ...
    function handleFileUpload(event) {
        ...
        if (file) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'http://localhost:3000/employee/import', true);  // Ensure POST method
    ...
    <script>
        function selectCSV() {
            ...
            csvInput.onchange = async function () {
                ...
                //    console.log(error);
                //}
                fetch('http://localhost:3000/v1/employees/import', {
                        method: 'POST',
                        body: data
                    })
                        .then(response => {
        ...
        function selectImages() {
            ...
            imagesInput.onchange = async function () {
                ...
                var response;
                fetch('http://localhost:3000/v1/employees/import/images', {
                    method: 'POST',
                    body: data
                })
                    .then(response => {
        ...
        function selectImage(personId) {
            ...
            imageInput.onchange = async function () {
                ...
                //alert(this.files[0]);
                var response;
                fetch('http://localhost:3000/v1/employees/'+personId+'/import/image', {
                    method: 'POST',
                    body: data
                })
                    .then(response => {
