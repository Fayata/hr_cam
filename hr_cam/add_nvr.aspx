<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="add_nvr.aspx.cs" Inherits="hr_cam.add_nvr" %>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                            <h5 class="text-white text-capitalize ps-3">Add Network Video Recorder</h5>
                        </div>
                    </div>
                        ...
                        <div style="margin: 15px;">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                  <asp:TextBox ID="TextBox3" CssClass="form-control" runat="server" TextMode="Password" ClientIDMode="Static"></asp:TextBox>
                                  <%--<span class="input-group-text" id="basic-addon2"><span class="material-icons" onclick="TogglePasswordVisibility('TextBox3', 'visibilityIcon1')" id="visibilityIcon1">visibility</span></span>--%>
        ...
        <%--function uploadData() {
            ...
            fetch('http://localhost:3000/v1/network-video-recorders', {
                ...
                .then(response => {
                    ...
                    window.location.href = 'nvr.aspx'; // Redirect to nvr.aspx
                })
                .catch(error => {
                    console.error(error);
