<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vms.aspx.cs" Inherits="hr_cam.Vms" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                <h5 class="text-white text-capitalize ps-3">Video Management Systems</h5>
              </div>
            </div>
            ...
            <div class="card-body px-0 pb-2">
                <a href="add_vms.aspx" class="btn" style="background-color: #0d6efd;color:white;margin:15px;">Add Video Management System</a>
    ...
    <script>
        function selectCSV() {
            ...
            csvInput.onchange = async function () {
                ...
                //    console.log(error);
                //}
                fetch('http://localhost:3000/v1/vmss/import', {
                    method: 'POST',
                    body: data
                })
                    .then(response => {
        ...
        function confirmDelete(event, id) {
            ...
            if (confirm('Are you sure you want to delete this item?')) {
                fetch(`http://localhost:3000/v1/vmss/${id}`, {
                    method: 'DELETE',
                    headers: {
