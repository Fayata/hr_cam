<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="report_people.aspx.cs" Inherits="hr_cam.Report_people" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                <h5 class="text-white text-capitalize ps-3">Report Unique Face Recognition</h5>
              </div>
            </div>
            ...
            <div class="card-body px-0 pb-2">
                <div class="row mb-5">
                    <div class="col-md-6">
                                <table style="width: 100%;margin:10px;" aria-describedby="filter_report_people">
                                    <tr>
                                        <th>Camera</th>
                                        <th>From</th>
                                        <th></th>
              ...
              <div class="table-responsive p-0" style="margin:5px;">
                  <table id="DataTable" class="table table-striped table-bordered" aria-describedby="people_list_report">
                      <thead>
                        <tr>
                            <th>Image</th>
                            <th></th>
