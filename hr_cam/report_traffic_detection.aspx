<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="report_traffic_detection.aspx.cs" Inherits="hr_cam.Report_traffic_detection" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                <h5 class="text-white text-capitalize ps-3">Report Traffic Detection</h5>
              </div>
            </div>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0" style="margin:5px;">
                  <table id="DataTable" class="table table-striped table-bordered" aria-describedby="traffic_list">
                      <thead>
                        <tr>
                            <th>Image</th>
                            <th>Occurred At</th>
