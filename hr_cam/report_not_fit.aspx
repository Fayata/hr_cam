...
AutoEventWireup="true" CodeBehind="report_not_fit.aspx.cs"
Inherits="hr_cam.report_not_fit" %>
          ...
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            ...
            >
              <h5 class="text-white text-capitalize ps-3">
                Report Face Recognition Invalid or Exception
              </h5>
              <%--
              <h5 class="text-white text-capitalize ps-3">
                Report People Detection
              </h5>
              --%>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      >
                        ...
                        <asp:ListItem Value="1" Text="Badge Expired" />
                        <asp:ListItem
                          Value="2"
