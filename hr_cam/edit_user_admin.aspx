<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="edit_user_admin.aspx.cs" Inherits="hr_cam.Edit_user_admin" %>
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                        <h5 class="text-white text-capitalize ps-3">Edit Users Admin</h5>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div style="margin: 15px;">
                            <div class="col-lg-6">
                                    <asp:TextBox ID="TextBox6" CssClass="form-control" runat="server" ClientIDMode="Static" style="display:none;"></asp:TextBox>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <input type="checkbox" name="update" id="update" onclick="ubah()"> &nbsp; Update Password
                                    <%--<input type="text" name="update_status" runat="server" id="update_status">--%>
                                    <asp:TextBox ID="TextBox5" CssClass="form-control" runat="server" ClientIDMode="Static" style="display:none;"></asp:TextBox>
...
<script>
    ...
    <script>
        function ubah() {
            ...
            var box = document.getElementById("ubah_password");
            if (update == true) {
                box.style.display = "block";
                document.getElementById("TextBox5").value = "yes";
            } else if (update == false) {
                box.style.display = "none";
                document.getElementById("TextBox5").value = "no";
            }
        }
    </script>
</asp:Content>
