<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_people_detection_pdf.aspx.cs" Inherits="hr_cam.Report_people_detection_pdf" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <table class="table" style="width:100%" aria-describedby="report">
                <tr>
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <%--<b style="font-size:20px">Report People Detection</b>--%>
                        <b style="font-size:20px">Report Face Recognition Fit To Work</b>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2">
