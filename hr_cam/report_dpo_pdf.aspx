<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_dpo_pdf.aspx.cs" Inherits="hr_cam.Report_dpo_pdf" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:100%" aria-describedby="report">
                <tr>
                    <th style="width: 50%;" align="left"><img src="bootstrap/logo.png" id="logonya" runat="server" class="img-fluid" alt=""/></th>
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <b style="font-size:20px">Report Face Recognition DPO</b>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2">
            ...
            <div class="table-responsive">
                <table class="table" style="width: 100%;" border="1" id="isitabel" aria-describedby="report_list">
                    <thead>
                        <tr>
                            <th>No</th>
