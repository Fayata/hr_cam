<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="report_event.aspx.cs" Inherits="hr_cam.Report_event" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                <h5 class="text-white text-capitalize ps-3">Report Event History</h5>
              </div>
            </div>
                                ...
                                <table style="width: 100%;margin:10px;" aria-describedby="filter">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <%--<asp:Button ID="btnExportExcel2" CssClass="btn btn-warning" runat="server" Text="Export Excel 2" OnClick="btnExportExcel2_Click" />--%>
                                        </td>
                                    </tr>
                                </table>
                    </div>
