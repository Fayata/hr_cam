...
namespace hr_cam
{
    public partial class Report_not_fit_pdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //Response.Write("camera site:"+Session["site_not_fit"].ToString());
                //Response.Write("camera:"+Session["camera"].ToString());
                //Response.Write("from_not_fit:"+Session["from_not_fit"].ToString());
                //Response.Write("to_not_fit:"+Session["to_not_fit"].ToString());
                FillEventHistory();
            }
        }
