<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_traffic_detection_pdf.aspx.cs" Inherits="hr_cam.Report_traffic_detection_pdf" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:100%" aria-describedby="report">
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <b style="font-size:20px">Report Traffic Detection</b>
                        <%--<b style="font-size:20px">Report traffic Detection</b>--%>
                    </td>
                </tr>
                <tr>
            ...
            <div class="table-responsive">
                <table class="table" style="width: 100%;" border="1" id="isitabel" aria-describedby="traffic_list">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Image</th>
