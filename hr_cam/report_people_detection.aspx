<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="report_people_detection.aspx.cs" Inherits="hr_cam.report_people_detection" %>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                <h5 class="text-white text-capitalize ps-3">Report Face Recognition Fit To Work</h5>
                <%--<h5 class="text-white text-capitalize ps-3">Report People Detection</h5>--%>
              </div>
            </div>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0" style="margin:5px;">
                  <table id="DataTable" class="table table-striped table-bordered" aria-describedby="people_list">
                      <thead>
                        <tr>
                            <th>Image</th>
                            <th></th>
