...
namespace hr_cam
{
    public partial class old_dashboard : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Session["from"] = dari;
            Session["to"] = ke;
            Response.Redirect("old_dashboard.aspx");
        }
        ...
        private void FillCard()
        {
            ...
            using (MySqlConnection con = new MySqlConnection(strcon))
            {
                ...
                string query8 = @"SELECT count(*) as jumlah from camera_events where type like '%plate%' and plate_number not in (SELECT plate_number from vehicles) and (plate_number!='' or plate_number!=null) and DATE(occurred_at)=@tanggal group by plate_number";
                ...
                string query13 = @"SELECT count(*) as jumlah from camera_events where type like '%plate%' and plate_number not in (SELECT plate_number from vehicles) and (plate_number!='' or plate_number!=null) and DATE(occurred_at) >=@tgl_1 AND DATE(occurred_at) <= @from group by plate_number";
