<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_daily_updated_vehicle_pdf.aspx.cs" Inherits="hr_cam.report_daily_updated_vehicle_pdf" %>
            ...
            <table style="width:100%" aria-describedby="report">
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <b style="font-size:20px">Report Daily Updated Vehicle</b>
                    </td>
                </tr>
            </table>
            <br/>
